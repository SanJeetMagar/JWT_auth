...
from .views import RegisterView, LoginView, VerifyEmailView, CustomTokenRefreshView, ForgotPasswordView, ResetPasswordView, ChangePasswordView, ProfileView, LogOutView, LoginOTPVerifyView
